...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <h2 class="mb-4" style="text-align: center; color:rgb(57, 116, 171)">Send me a message</h2>

            <!-- Form Kontak -->

                <!-- Input Nama -->
                <div class="form-group mb-3">
                    <label for="name" class="form-label" style="text-decoration-color: red">Name</label>
